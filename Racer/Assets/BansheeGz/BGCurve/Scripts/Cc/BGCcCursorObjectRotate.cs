...
namespace BansheeGz.BGSpline.Components
{
    ...
    public class BGCcCursorObjectRotate : BGCcWithCursorObject
    {
        ...
        [SerializeField]
        [Tooltip("Additional 360 degree revolutions around tangent. It's used only if rotationField is assigned. " +
                                  "It can be overriden with 'int' revolutionsAroundTangentField field.")]
        private int revolutionsAroundTangent;

        [SerializeField]
        [Tooltip("Field to store additional 360 degree revolutions around tangent for each point. It's used only if rotationField is assigned. " +
                                  "It should be an int field.")]
        private BGCurvePointField revolutionsAroundTangentField;

        [SerializeField]
        [Tooltip("By default revolutions around tangent is counter-clockwise. Set it to true to reverse direction. It's used only if rotationField is assigned." +
                                  "It can be overriden with bool field")]
